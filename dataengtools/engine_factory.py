...
class EngineFactory:
   ...
   def get_catalog_engine(self, provider: ProviderType, configuration: dict = {}) -> CatalogEngine[T]:
        if provider == None:
   ...
   def get_filesystem_engine(self, provider: ProviderType, configuration: dict = {}) -> FilesystemEngine[T]:
        if provider == None:
            raise ValueError('Provider is required')
